...
<img src="Images/PicsArt_03-13-04.49.08.png" width="100%" height="190px" style="margin-top:0px; border-radius:50px 50px 50px 50px;" />
    ...
    <%} %>
      ...
      <div style="width:650px; height:50px; color:white; background-color:#e60000; font-family:Arial; border-radius:15px 15px 15px 15px; border:2px solid black; margin-left:300px; font-weight:900;font-size: 30px">
        &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Give me a Blood
        </div>
        <br/> 
               ...
               <tr>
                ...
                <td> City*</td>
				 ...
				 <tr>
                  ...
                  <tr>
                    <td> When Required (Date)</td>
                   <td><input type="text" name="wrd" placeholder="(DD/MM/YYYY)"> </td>
                    </tr>
                 <tr>
                    <td>Contact Name*</td>
                    <td><input type="text" name="cnctname"></td>
                </tr>
                <tr>
                    <td> Mobile*</td>
                 ...
                 <tr>
                    <td> Message</td>
                    <td><input type="textarea" name="msg"></td>
                </tr>
